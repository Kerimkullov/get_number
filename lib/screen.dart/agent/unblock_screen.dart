...
class UnblockAgentScreen extends StatefulWidget {
  UnblockAgentScreen(
      {Key? key,
  ...
  bool block;
  @override
  _UnblockAgentScreenState createState() => _UnblockAgentScreenState();
}

class _UnblockAgentScreenState extends State<UnblockAgentScreen> {
        ...
        appBar: AppBar(
          leading: new IconButton(
            ...
            onPressed: () => Navigator.pushReplacement(context,
                MaterialPageRoute(builder: (context) => BlockedAgentsScreen())),
          ),
          centerTitle: true,
          title:
